...
export const UpdateFileTitleModal = () => {
    ...
    return <div className='modal-container'>
             <form className='modal-body' onSubmit={onSubmitModal}>
                ...
                <input required name="fileName" style={createFolderStyles.input} placeholder='Enter Card Name'/>
                <button style={createFolderStyles.btn} type='submit'>Update Card</button>
                </div>
             </form>
        </div>
}